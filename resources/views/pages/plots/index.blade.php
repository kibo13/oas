		...
		<table class="bk-table table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{ $plot->street->name }} {{ $plot->num_home }}{{ $plot->num_corp }}</td>
					<td>
						<div class="d-flex">

							<div class="bk-crud__wrap">
								<a href="{{ route('plots.edit', $plot) }}" class="bk-crud__btn btn btn-warning mr-1">
							...
							<div class="bk-crud__del btn btn-danger">
								<span class="bk-crud__del--link">
									<a href="javascript:void(0)" class="bk-btn-del" data-toggle="modal" data-target="#bk-delete-modal" data-id="{{ $plot->id }}" data-table-name="plot"></a>
								</span>
