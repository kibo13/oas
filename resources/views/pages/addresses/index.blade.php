					...
					<td>
						<div class="d-flex">
							...
							<div class="bk-crud__wrap">
								<a href="{{ route('addresses.edit', $address) }}" class="bk-crud__btn btn btn-warning mr-1">
							...
							<div class="bk-crud__del btn btn-danger">
								<span class="bk-crud__del--link">
									<a href="javascript:void(0)" class="bk-btn-del" data-toggle="modal" data-target="#bk-delete-modal" data-id="{{ $address->id }}" data-table-name="address"></a>
								</span>
