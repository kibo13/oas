    ...
    <div class="bk-form__wrap pb-2" data-info="Сведения на 6 часов">
      <div class="row p-0 m-0">
        ...
        <div class="bk-form__phw col-sm-auto form-group mb-2 pl-0 align-items-center d-flex flex-column">
          ...
          <input id="hw_pst" type="text" class="form-control bk-form__input" name="hw_pst" required placeholder="5.9" value="{{ old('hw_pst', isset($brief) ? $brief->hw_pst : null) }}">
        </div>
        ...
        <div class="bk-form__phw col-sm-auto form-group mb-2 pl-0 align-items-center d-flex flex-column">
          ...
          <input id="hw_pbk" type="text" class="form-control bk-form__input" name="hw_pbk" required placeholder="2.8" value="{{ old('hw_pbk', isset($brief) ? $brief->hw_pbk : null) }}">
        </div>
        ...
        <div class="bk-form__pcw col-sm-auto form-group mb-2 pl-0 align-items-center d-flex flex-column">
          ...
          <input id="cw_r" type="text" class="form-control bk-form__input" name="cw_r" required placeholder="3.1" value="{{ old('cw_r', isset($brief) ? $brief->cw_r : null) }}">
        </div>
        ...
        <div class="bk-form__pcw col-sm-auto form-group mb-2 pl-0 align-items-center d-flex flex-column">
          ...
          <input id="cw_ot" type="text" class="form-control bk-form__input" name="cw_ot" required placeholder="3.0" value="{{ old('cw_ot', isset($brief) ? $brief->cw_ot : null) }}">
        </div>
        ...
        <div class="bk-form__pcw col-sm-auto form-group mb-2 pl-0 align-items-center d-flex flex-column">
          ...
          <input id="cw_tf" type="text" class="form-control bk-form__input" name="cw_tf" required placeholder="3.2" value="{{ old('cw_tf', isset($brief) ? $brief->cw_tf : null) }}">
        </div>
        ...
        <div class="bk-form__pcw col-sm-auto form-group mb-2 pl-0 align-items-center d-flex flex-column">
          ...
          <input id="cw_fs" type="text" class="form-control bk-form__input" name="cw_fs" required placeholder="3.3" value="{{ old('cw_fs', isset($brief) ? $brief->cw_fs : null) }}">
        </div>
        ...
        <div class="bk-form__pcw col-sm-auto form-group mb-2 pl-0 align-items-center d-flex flex-column">
          ...
          <input id="cw_s" type="text" class="form-control bk-form__input" name="cw_s" required placeholder="3.1" value="{{ old('cw_s', isset($brief) ? $brief->cw_s : null) }}">
        </div>
