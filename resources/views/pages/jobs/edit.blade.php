...
<div class="overflow-hidden pt-4 py-2">
	...
	<form method="POST" action="{{ route('jobs.update', $job) }}" class="bk-form">
		...
		<div>
			...
			<div class=" bk-form__wrap pb-2" data-info="Работа">
			...
			<div class=" bk-form__wrap pb-2" data-info="Начало и окончание работ">
				<div class="row p-0 m-0">

					<div class="col-md-3 form-group mb-2 pl-0">
						<label for="date_on" class="bk-form__label mb-0">Дата и время начала работ </label>
					...
					<div class="col-md-3 form-group mb-2 pl-0">
						<label for="date_off" class="bk-form__label mb-0">Дата и время окончания работ</label>
