...
@section('content')
<div class="bk-users pt-4 py-2">
	<h2 class="bk-users-title">Пользователи</h2>

	<div class="bk-users-tools">
		<a href="" class="btn btn-outline-primary bk-users-tools__btn">
			Новый пользователь
		</a>
	</div>

	<div class="bk-users-table table-responsive">
