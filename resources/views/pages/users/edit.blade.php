    ...
    <div>
      ...
      <div class="bk-form__wrap" data-info="Пользователь">
        <div class="form-group mb-2">
          ...
          <input id="name" type="text" class="form-control bk-form__input @error('name') is-invalid @enderror" name="name" placeholder="Введите логин" autocomplete="off" value="{{ old('name', isset($user) ? $user->name : null) }}">
          @error('name')
