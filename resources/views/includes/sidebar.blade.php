...
<nav id="sidebar" class="bk-sidebar border-right">
  ...
  <ul class="bk-sidebar__list list-unstyled components my-2">
    <!-- <li class="bk-sidebar__item">
      <a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle bk-sidebar__link bk-sidebar__link--droptoggle d-flex align-items-start">
        <span class="bk-sidebar__link--icon d-flex align-items-start mx-2">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cubes" class="bk-sidebar__link--size svg-inline--fa fa-cubes fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <span class="bk-sidebar__link--icon">Сведения</span></a>
    ...
    <li @sbactive('subscribers.index')>
      <a href="{{ route('subscribers.index') }}" class="bk-sidebar__link d-flex align-items-start">
        <span class="bk-sidebar__link--icon d-flex align-items-start mx-2">
    ...
    <li @sbactive('works.index')>
      <a href="{{ route('works.index') }}" class="bk-sidebar__link d-flex align-items-start">
        <span class="bk-sidebar__link--icon d-flex align-items-start mx-2">
    ...
    <li @sbactive('workers.index')>
      <a href="{{ route('workers.index') }}" class="bk-sidebar__link d-flex align-items-start">
        ...
        <span class="bk-sidebar__link--icon">Сотрудники</span></a>
    </li>
    ...
    <li @sbactive('charts.index')>
      <a href="{{ route('charts.index') }}" class="bk-sidebar__link d-flex align-items-start">
        <span class="bk-sidebar__link--icon d-flex align-items-start mx-2">
