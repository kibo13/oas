...
-- Records of bids
-- ----------------------------
INSERT INTO `bids` VALUES (1, 2, 7, 22, NULL, 44, '2020-05-20', '11:15:00', 'Архипенко', '+7-777-333-11-22', 1, 6, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, '2020-05-29 09:40:20', '2020-05-29 09:40:20');
INSERT INTO `bids` VALUES (2, 2, 6, 4, NULL, 17, '2020-05-21', '15:13:00', 'Лужков', '7-07-11', 1, 15, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, '2020-05-29 10:36:32', '2020-05-29 10:43:04');
INSERT INTO `bids` VALUES (3, 2, 23, 9, NULL, 10, '2020-05-20', '15:38:00', 'Степанов', '+7-777-878-02-02', 2, 29, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, '2020-05-29 10:39:17', '2020-05-29 10:39:17');
...
CREATE TABLE `logs`  (
  ...
  `date_loc` date NULL DEFAULT NULL,
  `time_loc` time(0) NULL DEFAULT NULL,
  `solution` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  `prim` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `migrations` VALUES (47, '2020_05_27_161403_create_bids_table', 6);
INSERT INTO `migrations` VALUES (48, '2020_05_29_090209_create_logs_table', 6);
