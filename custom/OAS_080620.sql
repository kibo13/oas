...
CREATE TABLE `roles`  (
  ...
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  `info` tinyint(4) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
-- Records of roles
-- ----------------------------
INSERT INTO `roles` VALUES (1, 'Администратор', 'admin', NULL, '2020-05-23 16:14:59', 1);
INSERT INTO `roles` VALUES (3, 'Диспетчер ЖЭУ', 'disp_zheu', '2020-05-23 16:19:12', '2020-05-23 16:19:12', 1);
INSERT INTO `roles` VALUES (4, 'Диспетчер ОАС', 'disp_oas', '2020-05-23 16:19:26', '2020-05-23 16:19:26', 1);
INSERT INTO `roles` VALUES (5, 'Хэдхантер', 'hh', '2020-05-23 16:27:05', '2020-05-23 16:34:49', 1);
INSERT INTO `roles` VALUES (6, 'Аудитор', 'audit', '2020-05-23 16:29:17', '2020-05-23 16:34:39', NULL);
INSERT INTO `roles` VALUES (8, 'ПТС', 'pts', '2020-05-24 17:34:18', '2020-05-24 17:34:18', 1);
